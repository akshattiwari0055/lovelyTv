      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .lp-btn-primary:hover {
          ...
          box-shadow: 0 8px 30px rgba(212,242,68,0.28);
        }
        ...
        .lp-stat-label { font-size: 11px; color: var(--c-muted); text-transform: uppercase; letter-spacing: 0.6px; }
        ...
        .lp-feat-icon {
          ...
          border-radius: 11px;
          background: rgba(212,242,68,0.07);
          border: 1px solid rgba(212,242,68,0.11);
          display: flex; align-items: center; justify-content: center;
          color: var(--c-acc);
        }
        .lp-feat-card h3 {
        ...
        .lp-about-panel {
          ...
          border: 1px solid rgba(239,239,239,0.055);
        ...
        @media (max-width: 640px) {
          .lp-about-panel { padding: 30px 22px; }
        }
        .lp-about-grid {
          display: grid;
        ...
        .lp-about-card {
          ...
          gap: 10px;
          padding: 20px;
          background: rgba(239,239,239,0.025);
          border: 1px solid var(--c-line);
          border-radius: var(--r-lg);
        }
        .lp-about-card-icon {
